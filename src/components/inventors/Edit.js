...
class InventorsEdit extends React.Component {
  ...
  handleSubmit(e) {
    ...
    const inventorId = this.props.match.params.id

    axios.put(`api/inventors/${inventorId}`, this.state.formData, {
      headers: {Authorization: `Bearer ${token}` }
    })
      .then(() => this.props.history.push(`/inventors/${inventorId}`))
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  ...
                  onChange={this.handleChange}
                  value={this.state.formData.life || ''}
                />
              </div>
            ...
            <div className="field">
              ...
              <div className="control">
                <input
                  ...
                  onChange={this.handleChange}
                  value={this.state.formData.inventions || ''}
                />
              </div>
